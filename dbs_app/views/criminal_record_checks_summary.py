...
class CriminalRecordChecksSummaryView(NannyTemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        has_convictions_row = Row('has_convictions', 'Do you have any criminal cautions or convictions?', dbs_record['has_convictions'], 'dbs:Capita-DBS-Details-View', 'Change answer on criminal cautions or convictions')

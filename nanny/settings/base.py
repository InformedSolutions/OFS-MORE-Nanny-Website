"""
Django settings for django_govuk_app project.
...
PROJECT_APPS = [
    'template.apps.DjangoGovUKTemplateConfig'
]
...
ROOT_URLCONF = 'django_govuk_app.urls'
...
WSGI_APPLICATION = 'django_govuk_app.wsgi.application'
